...
<ul id="menu" class="side-nav fixed blue-grey darken-4"><!--Inicia ul-->
	...
	<li><a href="../inicio" class="white-text"><i class="material-icons white-text">home</i>Inicio</a></li>
	<li><div class="divider"></div></li>
	<li><a href="../usuarios" class="white-text"><i class="material-icons white-text">account_circle</i>Usuarios</a></li>
	<li><div class="divider"></div></li>
	<li><a href="../catalogo" class="white-text"><i class="material-icons white-text">book</i>Catalogo</a></li>
	<li><div class="divider"></div></li>
	...
	<li><div class="divider"></div></li>
	<li><a href="../inicio/slider.php" class="white-text"><i class="material-icons white-text">web</i>Slider</a></li>
	<li><div class="divider"></div></li>
